  ...
  <label class="form-check-label" >女</label>
	...
	<script type="text/javascript">
		...
		***/
		...
		//注意 这里是 .edit-btn   是标签内的自定义属性，只是这里加了 . 号
		...
		$(document).on("click",".delete-btn",function(){
			...
			//弹出是否确认删除对话框 
			 //之前没有添加前面的checkbox，所以是 td:eq(1) 后来表格最前面添加了 checkbox，所以就是 td:eq(2) 了
			//下面这句话的含义就是 找父类 tr ，然后找到第二个td元素 的文本内容，就是用户名，注意 eq 是从0开始算起的。
